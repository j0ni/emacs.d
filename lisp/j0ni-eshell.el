;;; j0ni-eshell.el --- eshell settings, copied blindly from ESK

;; ESK is defunct now, so I've grafted the eshell setup I was using
;; from there. At some point I'll probably get around to pruning this,
;; but right now I don't know much about what it does and don't care
...
(defun esk-eshell-in-dir (&optional prompt)
  ...
  (let* ((name (buffer-file-name))
         ...
         (buffer (cond ((eq 1 (length buffers)) (first buffers))
                       ((< 1 (length buffers)) (ivy-completing-read
